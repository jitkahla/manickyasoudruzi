      ...
      text={
        <div className="more">
          <div className="more__paragraph">
            ...
            narůstající nespokojenost velké většiny obyvatelstva s ekonomickou a
            politickou situací v zemi. V Polsku v roce 1980 nespokojenost
            ...
            další pády komunistických režimů v Maďarsku, Rumunsku a ve Východním
            Německu.
          </div>
          <div className="more__paragraph">
            ...
            do politiky východoevropských satelitů.] Během událostí listopadu a
            prosince 1989 dostali sovětští vojáci v Československu od Gorbačova
            příkaz zůstat v kasárnách a do dění v Československu nijak
            nezasahovat.
          </div>
          <div className="more__paragraph">
            ...
            ale studenti se přesunuli do centra města. Na Národní třídě se poté
            odehrál brutální zásah bezpečnostních složek: ten se stal symbolem
            počátku sametové revoluce.
          </div>
          <div className="more__paragraph">
          ...
          <div className="more__paragraph">
            ...
            reforem. Hranice na Západ se otevřely 4. prosince a prezident Gustáv
            Husák podal demisi 10. prosince. Václav Havel byl 29. prosince
